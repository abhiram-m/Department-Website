...
<ul class="menuul">
  ...
  <li class="menuli"><a href="#contact">Alumni</a></li>
  <li class="menuli"><a href="viewexam.jsp">Exams</a></li>
  
  <li class="menuli" style="float:right"><a href="#about">Logout</a></li>
  <li class="menuli" style="float:right"><a href="#about">Profile</a></li>
</ul>
