...
<form action="RegistrationServlet" method="post">
  ...
  <table>
   <tr>
   <td>First Name: </td><td> <input type="text" class="form-control" name="fname" required></td>
 ...
 <td>Last Name: </td>
  ...
  <tr>
 <td> NET ID: </td>
  <td>  <input type="text" class="form-control" name="netid" required></td>
  </tr>
  <tr>
  <td>Password: </td>
  <td>  <input type="password" class="form-control" name="password" required></td>
   ...
   <tr>
   <td>Role:</td><td> <select name="role" id="dd" onchange="show()">
...
function show(){
var student = document.getElementById("autoUpdate");
var role = document.getElementById("dd");
var text = role.options[role.selectedIndex].value;
if(text == "Student"){
