...
<body>
<ul class="menuul">
  <li class="menuli"><a href="studenthome.jsp">Home</a></li>
  <li class="menuli"><a href="DisplayCourseServlet">View Courses & TA Info</a></li>
   <li class="menuli"><a href="ProfessorEmailServlet">Professor email</a></li>
   <li class="menuli"><a href="CheckStatusServlet">My Status</a></li>
  ...
  <li class="menuli"><a href="ViewExamServlet">Exams</a></li>
   <li class="menuli"><a href="PreSuggestServlet">Course Suggestions</a></li>
   <li class="menuli"><a href="requirements.jsp">Course Requirements</a></li>
